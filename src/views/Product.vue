							...
							<div class="col-lg-6">
								...
								<div class="product-thumbs">
									<carousel class="product-thumbs-track ps-slider" :dots='false' :nav="false" :margin="15">
										<div class="pt" v-on:click="changeImage(thumbs[0])" v-bind:class="(thumbs[0] == gambarDefault) ? 'active' : '' ">
											<img src="img/mickey1.jpg" alt="" />
										</div>
										<div class="pt" v-on:click="changeImage(thumbs[1])" v-bind:class="(thumbs[1] == gambarDefault) ? 'active' : '' ">
											<img src="img/mickey2.jpg" alt="" />
										</div>
										<div class="pt" v-on:click="changeImage(thumbs[2])" v-bind:class="(thumbs[2] == gambarDefault) ? 'active' : '' ">
											<img src="img/mickey3.jpg" alt="" />
										</div>
										<div class="pt" v-on:click="changeImage(thumbs[3])" v-bind:class="(thumbs[3] == gambarDefault) ? 'active' : '' ">
